...
//2 procedury; 1 funkcja
#ifdef MixedAsm
void INWERSJAP1_6(); //Inwersja_diody_L8.A51
void WAIT_10US(int wait); //Wait_10uS.A51
...
data int ZEZWOLENIE_L8 = 40; // Zmienna udostepniana w procedurze napisanej w asemblerze
