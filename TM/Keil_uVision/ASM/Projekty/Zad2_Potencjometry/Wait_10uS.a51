...
;Wejscie
;Arg Number               char, 1-byte ptr       int, 2-byte ptr                long, float  4-byte                       generic ptr
...
;Upublicznie (udostepnienie na zewnatrz) symbolu zwiazanego z procedura przyjmujaca argumenty wejsciowe (wymaga uzupelnienia symbolu dodatkowym znakiem "podlogi")
		PUBLIC  _WAIT_10US ;procedura 1
		PUBLIC  _LONG_PARAM_LIST ;procedura 2
...
DATSEG      	SEGMENT DATA
		RSEG    DATSEG
		?_LONG_PARAM_LIST?BYTE: ;(long, long)=2*4bajty
