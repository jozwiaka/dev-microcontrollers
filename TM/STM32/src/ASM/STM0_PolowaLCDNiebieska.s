...
//R0 - adres poczatku 32b wskaznik jest intem
//R1 - rozmiar obszaru 32b
//R2 - kolor 16b
fillMemory:
strh r2,[r0] 
//zapisze r2 pod adres pamieci zawartej w r0
//zatem r0 = short int = 16b = 2bajty
add r0,r0,#2 //pixel++ //r0=r0+2,bo 2bajty
sub r1,r1,#1
cmp r1,#0
bne fillMemory
mov pc,lr //lr=link register
