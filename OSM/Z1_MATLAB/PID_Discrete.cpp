 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sat Apr 02 23:49:41 2022
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                PID_Discrete
...
extern void PID_Discrete_Start_wrapper(const real_T *p_Tp, const int_T p_width0,
...
extern void PID_Discrete_Outputs_wrapper(const real_T *e,
  real_T *u,
...
static void mdlStart(SimStruct *S)
{
  ...
  const real_T *p_Tp = (const real_T *) mxGetData(PARAM_DEF0(S));
  const real_T *p_kp = (const real_T *) mxGetData(PARAM_DEF1(S));
  const real_T *p_Ti = (const real_T *) mxGetData(PARAM_DEF2(S));
  const real_T *p_Td = (const real_T *) mxGetData(PARAM_DEF3(S));
  const real_T *p_Smin = (const real_T *) mxGetData(PARAM_DEF4(S));
  const real_T *p_Smax = (const real_T *) mxGetData(PARAM_DEF5(S));
  PID_Discrete_Start_wrapper(p_Tp, p_width0, p_kp, p_width1, p_Ti, p_width2,
    p_Td, p_width3, p_Smin, p_width4, p_Smax, p_width5);
}
...
{
  const real_T *e = (real_T *) ssGetInputPortRealSignal(S, 0);
  ...
  const real_T *p_Smin = (const real_T *) mxGetData(PARAM_DEF4(S));
  const real_T *p_Smax = (const real_T *) mxGetData(PARAM_DEF5(S));
  PID_Discrete_Outputs_wrapper(e, u, p_Tp, p_width0, p_kp, p_width1, p_Ti,
    p_width2, p_Td, p_width3, p_Smin, p_width4, p_Smax, p_width5);
}
